...
DEVICE_ID = 0x77 # Default device I2C address
...
class BME280Sensor:
    ...
    def read_all(self):
        ...
        OVERSAMPLE_HUM = 2
        self.i2c_bus.write_byte_data(self.i2c_device_id, REG_CONTROL_HUM, OVERSAMPLE_HUM)

        control = OVERSAMPLE_TEMP<<5 | OVERSAMPLE_PRES<<2 | MODE
        self.i2c_bus.write_byte_data(self.i2c_device_id, REG_CONTROL, control)

        # Read blocks of calibration data from EEPROM
        # See Page 22 data sheet
        cal1 = self.i2c_bus.read_i2c_block_data(self.i2c_device_id, 0x88, 24)
        cal2 = self.i2c_bus.read_i2c_block_data(self.i2c_device_id, 0xA1, 1)
        cal3 = self.i2c_bus.read_i2c_block_data(self.i2c_device_id, 0xE1, 7)
